...
public class SimManager : MonoBehaviour
{
    ...
    private void LoadCharacterScript(string charName, ChampionStats stats)
    {
        ...
        {
            case "Yone":
                stats.MyCombat = stats.gameObject.AddComponent<Yone>();
                break;
            case "Vex":
                stats.MyCombat = stats.gameObject.AddComponent<Vex>();
                break;
            case "Shaco":
                stats.MyCombat = stats.gameObject.AddComponent<Shaco>();
                break;
            case "Hecarim":
                stats.MyCombat = stats.gameObject.AddComponent<Hecarim>();
                break;
            case "Syndra":
                stats.MyCombat = stats.gameObject.AddComponent<Syndra>();
                break;
            case "Kayn":
