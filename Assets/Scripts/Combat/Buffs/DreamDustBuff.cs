...
public class DreamDustBuff : Buff
{
    ...
    public override void Update()
    {
        ...
        if (tickTimer >= 1)
        {
            manager.combat.UpdateTotalDamage(ref manager.combat.pSum, 4, new Damage((manager.combat.targetStats.maxHealth * 0.06f + (0.012f * (int)(manager.combat.myStats.AP / 100))) / 3, SkillDamageType.Spell, (SkillComponentTypes)41088), manager.combat.myStats.passiveSkill.skillName);
