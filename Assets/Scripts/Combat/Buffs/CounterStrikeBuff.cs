...
public class CounterStrikeBuff : Buff
{
    ...
    {
        float minimumdamage = manager.combat.ESkill().UseSkill(manager.combat.myStats.eLevel, manager.combat.eKeys[0], manager.combat.myStats, manager.combat.targetStats);
