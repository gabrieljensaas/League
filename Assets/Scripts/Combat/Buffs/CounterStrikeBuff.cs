...
public class CounterStrikeBuff : Buff
{
    ...
    public override void Kill()
    {
        ...
        manager.combat.UpdateTotalDamage(ref manager.combat.eSum, 2, new Damage(155 + ((1 + (value * 0.2f)) * 155) + (manager.combat.myStats.bonusAD * 0.5f), SkillDamageType.Phyiscal), manager.combat.myStats.eSkill[0].name);
