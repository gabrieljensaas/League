...
public class Taliyah : ChampionCombat
{
    ...
    public override IEnumerator ExecuteQ()
    {
        ...
        if (hasQActive)
        {
            UpdateTotalDamage(ref qSum, 0, new Damage(QSkill().UseSkill(4, qKeys[0], myStats, targetStats), SkillDamageType.Spell, SkillComponentTypes.Projectile), QSkill().basic.name);
            yield return new WaitForSeconds(0.3f);
            UpdateTotalDamage(ref qSum, 0, new Damage(QSkill().UseSkill(4, qKeys[1], myStats, targetStats), SkillDamageType.Spell, SkillComponentTypes.Projectile), QSkill().basic.name);
            yield return new WaitForSeconds(0.3f);
            UpdateTotalDamage(ref qSum, 0, new Damage(QSkill().UseSkill(4, qKeys[1], myStats, targetStats), SkillDamageType.Spell, SkillComponentTypes.Projectile), QSkill().basic.name);
            yield return new WaitForSeconds(0.3f);
            UpdateTotalDamage(ref qSum, 0, new Damage(QSkill().UseSkill(4, qKeys[1], myStats, targetStats), SkillDamageType.Spell, SkillComponentTypes.Projectile), QSkill().basic.name);
        ...
        {
            UpdateTotalDamage(ref qSum, 0, new Damage(QSkill().UseSkill(4, qKeys[2], myStats, targetStats), SkillDamageType.Spell, SkillComponentTypes.Projectile), QSkill().basic.name);
