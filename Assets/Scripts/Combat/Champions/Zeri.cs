...
public class Zeri : ChampionCombat
{
    ...
    /*protected override void CheckPassive()
    {
        ...
        if(myStats.attackSpeed > 1.5f)
        {
            myStats.AD += (myStats.attackSpeed - 1.5f) * 0.6f;
            myStats.attackSpeed = 1.5f;
        }
    }
    ...
    public override IEnumerator ExecuteQ()
    {
        ...
        myStats.qCD = 1 / myStats.attackSpeed;
    }
